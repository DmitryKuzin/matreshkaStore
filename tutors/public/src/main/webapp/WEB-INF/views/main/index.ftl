    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <div class="carousel-caption">
                <h2>MATRЁШKA TOY RIGHT NOW JUST FOR $100.00</h2>
                <div class="karusel-description">
                    <a href="/item?id=8" class="karusel-link">Learn more </a><a href="#" class="karusel-link">Buy</a>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="carousel-caption">
                ...
                <div class="karusel-description">
                    <a href="/catalog?category=3" class="karusel-link">Learn more </a><a href="#" class="karusel-link">Buy</a>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="carousel-caption">
                <div class="karusel-description"><a href="/item?id=6" class="karusel-link">Learn more </a><a href="/item?id=6" class="karusel-link" >Buy</a></div>
            </div>
        </div>
    </div>
</div>
